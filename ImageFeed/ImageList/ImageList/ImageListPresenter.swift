...
extension ImageListPresenter: ImageListPresenterProtocol {
    ...
    private func cellConfig(with photo: Photo) -> (dateStrign: String, imageURLString: String, isLikeImageString: String) {
...
extension ImageListPresenter: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let photo = photos[indexPath.row]
        let cellCongfig = cellConfig(with: photo)
        imagesListCell.delegate = self
        imagesListCell.config(date: cellCongfig.dateStrign,
                              imageURL: cellCongfig.imageURLString,
                              likeImage: cellCongfig.isLikeImageString,
